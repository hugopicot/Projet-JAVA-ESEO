...
public class SignalementCommentaire {
    ...
    public SignalementCommentaire(int id_utilisateur, int id_commentaire) {
        this.id_utilisateur = id_utilisateur;
        this.id_commentaire = id_commentaire;
    }

    // Getters
    public int getId_signalement_com() { return id_signalement_com; }
    public int getId_utilisateur() { return id_utilisateur; }
    public int getId_commentaire() { return id_commentaire; }

    // Setters
    public void setId_signalement_com(int id_signalement_com) { this.id_signalement_com = id_signalement_com; }
}
