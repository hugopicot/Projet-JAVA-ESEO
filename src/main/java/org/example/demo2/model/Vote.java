...
public class Vote {
    ...
    private int id_post;
    private Integer id_commentaire; // Integer pour permettre null

    public Vote(int id_vote, int type_vote, LocalDateTime date_vote, int id_utilisateur, int id_post, Integer id_commentaire) {
    ...
    public Vote(int type_vote, int id_utilisateur, int id_post, Integer id_commentaire) {
        this.type_vote = type_vote;
    ...
    public int getType_vote() { return type_vote; }
